...
A proposta do sistema é integrar, em uma única base de dados, informações sobre atletas, técnicos, equipes, modalidades, treinos, jogos, avaliações físicas e controle de lesões, possibilitando o acompanhamento estruturado das atividades esportivas e facilitando a análise da evolução dos atletas ao longo do tempo.

Inicialmente, o projeto foi desenvolvido com foco na modelagem conceitual e lógica do banco de dados, incluindo a elaboração de diagramas UML, modelo entidade-relacionamento, dicionário de dados e normalização até a Terceira Forma Normal (3FN). Posteriormente, foi realizada a implementação do banco de dados utilizando SQL, contemplando a criação das tabelas, definição de chaves primárias e estrangeiras, e a utilização das operações fundamentais de manipulação de dados (CRUD).
